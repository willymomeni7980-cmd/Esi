...
# پلن‌های Gaming (لینک اشتراک جداگانه)
GAMING_PLANS = {
    "gaming_1gb": {
        "name": "Gaming اشتراک ۱ گیگ",
        "size": "۱ گیگابایت",
        "duration": "نامحدود",
        "price": int(os.environ.get("PRICE_GAMING_1GB", "290000")),
        "type": "gaming",
    },
    "gaming_2gb": {
        "name": "Gaming اشتراک ۲ گیگ",
        "size": "۲ گیگابایت",
        "duration": "نامحدود",
        "price": int(os.environ.get("PRICE_GAMING_2GB", "540000")),
        "type": "gaming",
    },
    "gaming_3gb": {
        "name": "Gaming اشتراک ۳ گیگ",
        "size": "۳ گیگابایت",
        "duration": "نامحدود",
        "price": int(os.environ.get("PRICE_GAMING_3GB", "750000")),
        "type": "gaming",
    },
    "gaming_5gb": {
        "name": "Gaming اشتراک ۵ گیگ",
        "size": "۵ گیگابایت",
        "duration": "نامحدود",
        "price": int(os.environ.get("PRICE_GAMING_5GB", "1150000")),
        "type": "gaming",
    },
    "gaming_10gb": {
        "name": "Gaming اشتراک ۱۰ گیگ",
        "size": "۱۰ گیگابایت",
        "duration": "نامحدود",
        "price": int(os.environ.get("PRICE_GAMING_10GB", "2100000")),
        "type": "gaming",
    },
}
